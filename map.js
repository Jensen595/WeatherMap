...
navigator.geolocation.getCurrentPosition(position => {
    ...
    // API endpoint.
    const API = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${KEY}&units=metric`;
    ...
    fetch(API)
      ...
      .then(data => {
        ...
        const IconUrl = `http://openweathermap.org/img/w/${weather}.png`;
